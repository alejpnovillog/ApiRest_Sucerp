...
class AbmTablas():
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # Obtengo un registr de una tabla con un where de alguns campos de su regitro
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # Obtener instancia de Objeto Tabla
    def __getObjetoTabla(self):
        ...
        try:
            ...
            # v es el diccionario con el numero y su nombre del atributo de la clase gestionRegistros
